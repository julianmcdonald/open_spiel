...
using open_spiel::dune_imperium::DuneImperiumGame;
...
void open_spiel::init_pyspiel_games_dune_imperium(py::module& m) {
  ...
  py::classh<DuneImperiumState, State>(m, "DuneImperiumState")
    ...
    .def("set_player_draw_deck", &DuneImperiumState::SetPlayerDrawDeckForTesting,
         py::arg("player"), py::arg("deck"))
    ...
    .def("set_tleilaxu_row", &DuneImperiumState::SetTleilaxuRowForTesting,
         py::arg("row"))
    .def("set_imperium_draw_deck", &DuneImperiumState::SetImperiumDrawDeckForTesting,
         py::arg("deck"))
    ...
    .def("set_player_intrigues", &DuneImperiumState::SetPlayerIntriguesForTesting,
         py::arg("player"), py::arg("intrigues"))
    .def("set_player_intrigue_hand", &DuneImperiumState::SetPlayerIntrigueHandForTesting,
         py::arg("player"), py::arg("cards"))
    .def("set_intrigue_draw_deck", &DuneImperiumState::SetIntrigueDrawDeckForTesting,
         py::arg("deck"))
    ...
    .def("set_player_persuasion", &DuneImperiumState::SetPlayerPersuasionForTesting,
    ...
    .def("set_player_dreadnoughts_in_garrison",
         ...
         py::arg("player"), py::arg("amount"))
    .def("set_agent_space_owner", &DuneImperiumState::SetAgentSpaceOwnerForTesting,
         py::arg("board_index"), py::arg("player"))
    .def("set_high_council_owned", &DuneImperiumState::SetHighCouncilOwnedForTesting,
    ...
    .def("set_tech_tile_owned", &DuneImperiumState::SetTechTileOwnedForTesting,
         py::arg("player"), py::arg("tech_id"))
    .def("set_tech_tiles_owned", &DuneImperiumState::SetTechTilesOwnedForTesting,
         py::arg("player"), py::arg("tiles"))
    ...
    .def("set_tech_negotiators", &DuneImperiumState::SetTechNegotiatorsForTesting,
         py::arg("player"), py::arg("amount"))
    .def("set_specimens", &DuneImperiumState::SetSpecimensForTesting,
         py::arg("player"), py::arg("amount"))
    .def("set_current_conflict", &DuneImperiumState::SetCurrentConflictForTesting,
         py::arg("conflict_id"))
    ...
    .def("set_player_revealed", &DuneImperiumState::SetPlayerRevealedForTesting,
         py::arg("player"), py::arg("revealed"))
    .def("set_mentat_available", &DuneImperiumState::SetMentatAvailableForTesting,
         py::arg("val"))
    ...
    .def("get_player_draw_deck", &DuneImperiumState::GetPlayerDrawDeckForTesting,
         py::arg("player"), py::return_value_policy::reference_internal)
    ...
    .def("get_player_vp", &DuneImperiumState::GetPlayerVpForTesting,
         py::arg("player"))
    .def("get_player_persuasion", &DuneImperiumState::GetPlayerPersuasionForTesting,
         py::arg("player"))
    .def("get_player_influence", &DuneImperiumState::GetPlayerInfluenceForTesting,
    ...
    .def("get_player_dreadnoughts_in_garrison",
         ...
         py::arg("player"))
    .def("get_agent_space_owner", &DuneImperiumState::GetAgentSpaceOwnerForTesting,
         py::arg("board_index"))
    .def("player_leader", &DuneImperiumState::PlayerLeader,
         py::arg("player"))
    ...
    .def("get_reveal_persuasion_bonus",
         ...
         py::arg("player"))
    .def("get_topdeck_acquire", &DuneImperiumState::GetTopdeckAcquireForTesting,
         py::arg("player"))
    ...
    .def("get_player_solari_direct", &DuneImperiumState::GetPlayerSolari,
         py::arg("player"))
    .def("player_shipping_level", &DuneImperiumState::PlayerShippingLevelForTesting,
         py::arg("player"))
    .def("get_tech_stack_size", &DuneImperiumState::GetTechStackSizeForTesting,
         py::arg("stack"))
    ...
    .def("get_atomics_used", &DuneImperiumState::GetAtomicsUsedForTesting,
         py::arg("player"))
    .def("get_reserve_supply_tsmf", &DuneImperiumState::GetReserveSupplyTsmfForTesting)
    ...
    .def("gain_troops", &DuneImperiumState::GainTroopsForTesting,
         py::arg("player"), py::arg("count"))
    .def("grant_troops_to_combat", &DuneImperiumState::GrantTroopsToCombatForTesting,
         py::arg("player"), py::arg("count"))
    .def("gain_specimens", &DuneImperiumState::GainSpecimensForTesting,
         py::arg("player"), py::arg("count"))
    .def("gain_tech_negotiators", &DuneImperiumState::GainTechNegotiatorsForTesting,
         py::arg("player"), py::arg("count"))
    ...
    .def("acquire_imperium_card", &DuneImperiumState::AcquireImperiumCardForTesting,
         py::arg("player"), py::arg("card_id"), py::arg("to_topdeck"))
